...
- Crear un servicio web que diga la hora actual
```C#
[WebMethod]
public string Hora()
{
...
### Diseños fundamentales para REST
...
- Operaciones bien definidas: POST, GET, PUT y DELETE. Con frecuencia se equiparan a CRUD.
- Sintaxis universal.
- Uso de hipermedios (HTML o XML).
